<script>
    ...
    const { dataset, metric, data_digest, score_summary, completed, onclick } = $props();
...
<div class="">
    <div class="flex w-full border border-orange-300 shadow shadow-orange-300 rounded-lg">
        <Caret {expanded} {onToggleExpansion} />
