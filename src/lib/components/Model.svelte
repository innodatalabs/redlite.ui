<script>
    ...
    const { model, score_summary, completed, run, meanWinRate, wins, onclick, expandable=true } = $props();
...
<div>
    <div class="flex border border-green-300 shadow shadow-green-300 rounded-lg ">
